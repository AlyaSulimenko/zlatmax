  ...
  if (document.querySelector(".icon-menu")) {
    document.addEventListener("click", function (e) {
      ...
      if (bodyLockStatus && e.target.closest(".icon-menu")) {
        ...
        if (document.documentElement.classList.contains("catalogue-open")) {
          document.documentElement.classList.remove("catalogue-open");
        }
        if (submenuCatalogue.classList.contains("_submenu-catalogue-opened")) {
          console.log(
            submenuCatalogue.classList.contains("_submenu-catalogue-opened")
          );
